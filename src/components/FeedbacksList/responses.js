...
const responses = [
  {
    ...
    responseUA:
      'Тетяна здатна підвищити настрій, прибрати скованість перед камерою, створити приємну атмосферу. \nСвітлини Тетяни - це можливість побачити чудо в звичайному. Вони багато чого розровідають не тільки про людей на світлинах, але і про талант фотографа надіхнути незабутньою радістю кожну мить життя.',
    responsePL:
